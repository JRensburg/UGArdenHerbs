...
class IntroView: UITableViewController{
   ...
   // self.tableView.backgroundView = UIImageView(image: UIImage(named: "dryHerbs.jpg"))
        ...
        imageView.frame = CGRect(x: 0, y: 0, width: self.view.frame.width / 3, height: ((self.navigationController?.navigationBar.frame.height)! * 0.75
        ))
        ...
        self.navigationItem.titleView?.snp.makeConstraints{
            $0.height.equalToSuperview().dividedBy(4/3)
        }
