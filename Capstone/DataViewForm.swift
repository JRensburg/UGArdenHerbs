...
class DataViewForm: FormViewController, FormUtils {
    ...
    var sendUrl : String
    var authentication = "api_key=keyhr7xMO6nFfKreF&Content-Type=application/json"
    var postUrl: String
    var id: String?
    ...
    override func viewDidLoad() {
        ...
        switch section {
        case 0:
            sendUrl = "https://api.airtable.com/v0/appKc1Zd3BiaCTlOs/Seed%20Data/"
            self.navigationItem.title = "Edit - Seeding Form"
            dict = (model.fields.value as! SeedingData).dictionary2
            configureSeedForm()
        case 1:
            sendUrl = "https://api.airtable.com/v0/apptgk0JBqpaqbtT4/Drying%20Data/"
            self.navigationItem.title = "Edit - Drying Form"
            dict = (model.fields.value as! DryingData).dictionary2
            configureHerbForm()
        case 2:
            sendUrl = "https://api.airtable.com/v0/app0rj69BsqZwu9pS/Tea%20Data/"
